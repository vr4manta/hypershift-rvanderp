...
func NewCreateCommand(coreOpts *core.CreateNodePoolOptions) *cobra.Command {
	...
	cmd.Flags().StringVar(&o.datacenter, "vcenter", o.network, "The datacenter attached to the node to be deployed")
...
func (o *opts) UpdateNodePool(ctx context.Context, nodePool *hyperv1.NodePool, hcluster *hyperv1.HostedCluster, client crclient.Client) error {
	nodePool.Spec.Platform.VSphere = &hyperv1.VSpherePlatformSpec{
		TemplateVM:        o.template,
		Network:           o.network,
		...
		MemoryMiB:         o.memoryMB,
		VCenter:           o.vcenter,
		NumCoresPerSocket: o.coresPerSocket,
		NumCPUs:           o.cpus,
		DiskSizeGiB:       o.diskSizeGB,
	}
